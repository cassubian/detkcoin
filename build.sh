...
sudo apt-get install libboost-all-dev libboost1.55-all-dev libdb++-dev libdb5.3++-dev libdb5.3-dev -y
mv src/rpcrawtransaction.cpp src/rpcrawtransaction48.cpp
mv src/rpcrawtransaction58.cpp src/rpcrawtransaction.cpp
qmake
make
